  ...
  return new Promise((resolve) => {
    loader.load(
      ...
      (gltf) => {
        ...
        // This is the "cleanest" way to apply a single color 
        // to all parts of the robot link.
        model.traverse((child) => {
          if (child.isMesh) {
            child.material.color.setHex(0xFFCC00); // Stäubli Yellow
          }
        });
      ...
      undefined,
      (err) => {
        console.warn(`Could not load ${name}.glb`, err);
        resolve(null);
      }
    );
  });
